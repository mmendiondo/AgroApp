class EstablecimientosController < ApplicationController
  ...
  def index
    ...
    @establecimientos = initialize_grid(Establecimiento, 
        name: 'establecimiento', 
        enable_export_to_csv: true,
        csv_field_separator: ';',
        csv_file_name: 'Establecimientos', per_page: 2)

    export_grid_if_requested('establecimiento' => 'establecimientos_grid') do
      #render '_establecimientos_grid'
  ...
  private
    ...
    def establecimiento_params
      params.require(:establecimiento).permit(:nombre, :descripcion, :precio, :cantidad)
    end
end
